...
![缓存example](../../Assets/images/缓存-example.png)
```js
const fs = require('fs');
...
![node服务-强制缓存](../../Assets/images/强制缓存1.png)

2）浏览器：    
![浏览器-强制缓存](../../Assets/images/强制缓存-浏览器.png)
...
1）node端：   
![node服务-协商缓存](../../Assets/images/协商1-node.png)

2）浏览器：第二次请求   
![浏览器-协商缓存](../../Assets/images/协商1-浏览器.png)
![浏览器-协商缓存](../../Assets/images/协商1-浏览器1.png)
...
1）node端：   
![node服务-协商缓存](../../Assets/images/协商2-node.png)

2）浏览器：第二次请求   
![浏览器-协商缓存](../../Assets/images/协商2-浏览器.png)
![浏览器-协商缓存](../../Assets/images/协商2-浏览器1.png)

# 3. 最佳做法：强制与协商并存
![结合使用](../../Assets/images/缓存.jpg)
...
![webpack](../../Assets/images/缓存-webpack.png)
```js
