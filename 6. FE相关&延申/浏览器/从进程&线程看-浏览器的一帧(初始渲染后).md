...
- FPS全称为**Frams Per Second**，即**每秒的帧数**，也就是**渲染流水线每秒更新的帧数**。网页上我们看到的各种各样的效果，都是一个帧一个帧渲染出来的。可以将一个帧理解成一个画面，FPS就是每秒画面更新的次数。如果咱们页面上有动画，FPS越大，动画就越流畅。这里摘抄[一位大佬](https://zhuanlan.zhihu.com/p/78569750)的数据：  
...
![一帧](https://gitee.com/ahuang6027/blog-images/raw/master/images/process-one-frame.png)
